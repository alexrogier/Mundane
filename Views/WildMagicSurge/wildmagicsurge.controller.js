app.controller("wildmagicsurgeController", ["$scope", "$log", function ($scope, $log) {
    ...
    $scope.modifyd100 = function (mod) {
        $scope.d100.value += mod;
        if ($scope.d100.value < $scope.d100.options.floor) $scope.d100.value = $scope.d100.options.floor;
        if ($scope.d100.value > $scope.d100.options.ceil) $scope.d100.value = $scope.d100.options.ceil;
    }

    $scope.getWildMagic = function () {
        $scope.rollResult = $scope.wildMagic[$scope.d100.value - 1];
    }
    ...
    $scope.wildMagic = [
        ...
        /* 003 */ "You polymorph into a chicken for the next minute or until you take damage.",
        ...
        /* 022 */ "The last spell you cast is cast an additional time without cost.",
        ...
        /* 044 */ "A rust monster burrows from the ground 5 ft. in front of you and attacks you. The monster has 40 hit points, has +4 to hit and deals 1d12+3 bludgeoning plus 1d4 necrotic damage.",
        /* 045 */ "An extra arm grows from your neck. You suffer disadvantage on any skill check requiring sight. You gain your proficiency bonus when performing strength checks.",
        ...
        /* 049 */ "You begin hiccupping intensely for the next minute. Whenever you attempt to cast a spell, you must succeed on a Con save DC 18 or the spell fails.",
        ...
        /* 059 */ "You gain resistance to all non-magical damage for the next 1d4 hours.",
        ...
        /* 062 */ "You become a plant until the start of your next turn. While a plant, you are incapacited and have vulnerability to all damage. If you drop to 0 hit points, your form reverts.",
        ...
        /* 069 */ "All hair on your body completely falls off and won't regrow until 24 hours pass.",
        ...
        /* 075 */ "Your arms and legs change positions with each other for the next hour.",
        ...
        /* 080 */ "You hallucinate that 1d100 rats sporadically come up from the ground and attack you for the next minute. At the beginning of each of your turns, you're dealt 1d6 slashing damage.",
        /* 081 */ "A nearby creature must succeed on a Charisma save DC 18 or become charmed by you for the next minute.",
        ...
        /* 084 */ "A wraith with 60 hit points randomly appears and fights by your side. The wraith will remain summoned for up to a minute or until defeated. Each of the wraiths attacks have +6 to hit and deal 2d6 Necrotic damage.",
        ...
        /* 087 */ "For the next hour, you must shout your opinion of all creatures that you come across when you first approach them.",
        ...
        /* 094 */ "For the next minute, all spells and ranged weapon attack projectiles or emissions within 100 ft. of you do not go away after inflicting harm. This causes the projectiles or emissions to bounce off surfaces, continuously inflicting harm upon those within the vicinity.",
